 ...
 * Last generated by Dialog Designer at: 2016-AUG-05  11:35:45 AM
 */
public class languageSelectPromptAndCollect extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-05  11:35:45 AM
	 */
	public languageSelectPromptAndCollect() {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build prompt names for field: "languageSelectPromptAndCollect"
		promptNames = new java.util.ArrayList();
		promptNames.add("prSelectLang");

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("grLangSelect", "1.0"));

		// build events for the field: "languageSelectPromptAndCollect"
		events = new java.util.ArrayList(2);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, "prSelectLangNoInput", new com.avaya.sce.runtime.Goto("languageSelectPromptAndCollect", 0, true, ""));
		events.add(event);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String)null, new com.avaya.sce.runtime.Goto("selectLangExtraData", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		field = new com.avaya.sce.runtime.Field("languageSelectPromptAndCollect", false, true, grammarInfo, promptNames, events, properties, 1, false, false);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("langData");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "language seletion start", ""));
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "language selection end", ""));
		return(list);
	}
	/**
