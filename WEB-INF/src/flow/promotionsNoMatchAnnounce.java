 ...
 * Last generated by Dialog Designer at: 2016-AUG-23  09:22:54 AM
 */
public class promotionsNoMatchAnnounce extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-23  09:22:54 AM
	 */
	public promotionsNoMatchAnnounce() {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("promotionsPromptAndCollect");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "promotions no match prompt", "merchant4Value"));
		return(list);
	}
	/**
