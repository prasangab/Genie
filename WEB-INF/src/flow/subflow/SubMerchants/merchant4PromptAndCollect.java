 ...
 * Last generated by Dialog Designer at: 2016-AUG-17  09:54:16 PM
 */
public class merchant4PromptAndCollect extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-17  09:54:16 PM
	 */
	public merchant4PromptAndCollect() {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build prompt names for field: "merchant4PromptAndCollect"
		promptNames = new java.util.ArrayList();
		promptNames.add("prMerchant4");

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("grMerchants4", "1.0"));

		// build events for the field: "merchant4PromptAndCollect"
		events = new java.util.ArrayList(2);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, "prMerchant4NoInput", new com.avaya.sce.runtime.Goto("SubMerchants-merchant4PromptAndCollect", 0, true, ""));
		events.add(event);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String)null, new com.avaya.sce.runtime.Goto("SubMerchants-merchant4ExtraData", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		field = new com.avaya.sce.runtime.Field("merchant4PromptAndCollect", false, true, grammarInfo, promptNames, events, properties, 1, false, false);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SubMerchants-merchant4Data");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "merchant 4 p&c", "merchantsValue"));
		return(list);
	}
	/**
