 ...
 * Last generated by Dialog Designer at: 2016-AUG-23  11:27:42 AM
 */
public class merchant1NoMatchAnnounce extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-23  11:27:42 AM
	 */
	public merchant1NoMatchAnnounce() {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SubMerchants-merchant1PromptAndCollect");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "merchant 1 no match prompt", "checkMaxTries:noOfTries"));
		return(list);
	}
	/**
