 ...
 * Last generated by Dialog Designer at: 2016-AUG-15  06:26:29 AM
 */
public class promotionsPromptAndCollect extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-15  06:26:29 AM
	 */
	public promotionsPromptAndCollect() {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build prompt names for field: "promotionsPromptAndCollectCopy"
		promptNames = new java.util.ArrayList();
		promptNames.add("prPromotions");

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("grPromotions", "1.0"));

		// build events for the field: "promotionsPromptAndCollectCopy"
		events = new java.util.ArrayList(2);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, "prPromotionsNoInput", new com.avaya.sce.runtime.Goto("SubPromotions-promotionsPromptAndCollect", 0, true, ""));
		events.add(event);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String)null, new com.avaya.sce.runtime.Goto("SubPromotions-promotionsExtraData", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		field = new com.avaya.sce.runtime.Field("promotionsPromptAndCollectCopy", false, true, grammarInfo, promptNames, events, properties, 1, false, false);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SubPromotions-promotionsData");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "promotions p&c", "serviceValue"));
		return(list);
	}
	/**
