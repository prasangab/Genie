 ...
 */
public class Discoonect extends com.avaya.sce.runtime.Disconnect {
	 ...
	 * Last generated by Dialog Designer at: 2016-SEP-05  01:07:37 PM
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("endData", false);
		list.add(event);
		return(list);
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "disconnect", ""));
		return(list);
	}
	/**
