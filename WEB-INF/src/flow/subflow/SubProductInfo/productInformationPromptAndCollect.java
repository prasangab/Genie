 ...
 * Last generated by Dialog Designer at: 2016-AUG-15  06:25:07 AM
 */
public class productInformationPromptAndCollect extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-15  06:25:07 AM
	 */
	public productInformationPromptAndCollect() {
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build prompt names for field: "productInformationPromptAndCollectCopy"
		promptNames = new java.util.ArrayList();
		promptNames.add("prProductInformation");

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("grProductInfo", "1.0"));

		// build events for the field: "productInformationPromptAndCollectCopy"
		events = new java.util.ArrayList(2);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, "prProductInfoNoInput", new com.avaya.sce.runtime.Goto("SubProductInfo-productInformationPromptAndCollect", 0, true, ""));
		events.add(event);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String)null, new com.avaya.sce.runtime.Goto("SubProductInfo-productInfoExtraData", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		field = new com.avaya.sce.runtime.Field("productInformationPromptAndCollectCopy", false, true, grammarInfo, promptNames, events, properties, 1, false, false);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("SubProductInfo-productInfoData");
		return submit;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "product information p&c", "serviceValue"));
		return(list);
	}
	/**
