 ...
 * Last generated by Dialog Designer at: 2016-AUG-18  02:57:09 PM
 */
public class agentTransfer extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Transfer getTransfer(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		transfer = new com.avaya.sce.runtime.Transfer("agentTransfer", "agentTranferVDN", com.avaya.sce.runtime.Transfer.VARIABLE, null, "0s", com.avaya.sce.runtime.Transfer.CONSTANT, "0s", com.avaya.sce.runtime.Transfer.TransferType.BLIND, promptNames, null, this, "", com.avaya.sce.runtime.Transfer.CONSTANT, false, false);
		return transfer;
	}
	/**
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "transfer to agent", ""));
		return(list);
	}
	/**
