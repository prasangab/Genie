 ...
 * Last generated by Dialog Designer at: 2016-AUG-05  11:00:07 AM
 */
public class welcomeGenieServices extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "welcome prompt", "start"));
		return(list);
	}
	/**
