 ...
 * Last generated by Dialog Designer at: 2016-AUG-15  06:27:08 AM
 */
public class deactivateServicePromptAndCollect extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-15  06:27:08 AM
	 */
	public deactivateServicePromptAndCollect() {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-22  11:39:38 AM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build prompt names for field: "deactivateServicePromptAndCollect"
		promptNames = new java.util.ArrayList();
		promptNames.add("prDeactService");

		// build the list of grammar information objects for the field
		grammarInfo = new java.util.ArrayList(1);
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("grDeactService", "1.0"));

		// build events for the field: "deactivateServicePromptAndCollect"
		events = new java.util.ArrayList(2);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, "prDeactServiceNoInput", new com.avaya.sce.runtime.Goto("deactivateServicePromptAndCollect", 0, true, ""));
		events.add(event);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, "prDeactServiceNoMatch", new com.avaya.sce.runtime.Goto("deactivateServicePromptAndCollect", 0, true, ""));
		events.add(event);
		properties = new java.util.ArrayList();

		field = new com.avaya.sce.runtime.Field("deactivateServicePromptAndCollect", false, true, grammarInfo, promptNames, events, properties, 1, false, false);
		list.add(field);
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Discoonect");
		return submit;
	}
	/**
