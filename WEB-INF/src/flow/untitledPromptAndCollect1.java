 ...
 * Last generated by Dialog Designer at: 2016-AUG-18  04:55:12 PM
 */
public class untitledPromptAndCollect1 extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Dialog Designer at: 2016-AUG-19  11:06:17 AM
	...
	public java.util.Collection getFields(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		// build prompt names for field: "untitledPromptAndCollect_input"
		...
		grammarInfo.add(new com.avaya.sce.runtime.GrammarInfo("", "1.0"));

		// build events for the field: "untitledPromptAndCollect_input"
		events = new java.util.ArrayList(2);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (String)null, null);
		events.add(event);
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String)null, null);
		events.add(event);
		properties = new java.util.ArrayList();

		field = new com.avaya.sce.runtime.Field("untitledPromptAndCollect_input", false, true, grammarInfo, promptNames, events, properties, 1, false, false);
		list.add(field);
	...
	public java.util.Collection getTrackingActions(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.tracking.TraceInfo(com.avaya.sce.runtimecommon.ITraceInfo.TRACE_LEVEL_DEBUG, "test...!!!", ""));
		return(list);
	}
	/**
